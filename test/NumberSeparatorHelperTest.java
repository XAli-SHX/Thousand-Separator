...
import ir.alishayanpoor.NumberSeparatorHelper;
import org.junit.jupiter.api.Test;

import static org.junit.jupiter.api.Assertions.*;

class NumberSeparatorHelperTest {

    @Test
    public void ThousandSeparate_BigNumber_SeparateAsNormal() {
        String number = "999999999999";
        String expected = "999,999,999,999";
        String actual = NumberSeparatorHelper.thousandSeparate(number);
